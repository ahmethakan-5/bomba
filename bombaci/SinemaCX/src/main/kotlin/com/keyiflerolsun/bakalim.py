...
def sinemaCX(film_url:str) -> dict:
    ...
    oturum.headers.update({"Referer": "https://www.sinema.gg/"})
    ...
    video_istek = oturum.post("https://panel.sinema.gg/player/index.php?data=" + iframe_link.split("/")[-1] + "&do=getVideo")
...
konsol.print(sinemaCX("https://www.sinema.gg/film/lovelace-izle/"))
konsol.print(sinemaCX("https://www.sinema.gg/film/intihar-odasi/"))
konsol.print(sinemaCX("https://www.sinema.gg/film/alacakaranlik-5-izle/"))
konsol.print(sinemaCX("https://www.sinema.gg/film/titanik-filmi-full-1080p-izle-yeni/"))
konsol.print(sinemaCX("https://www.sinema.gg/film/challengers-2023-izle/"))
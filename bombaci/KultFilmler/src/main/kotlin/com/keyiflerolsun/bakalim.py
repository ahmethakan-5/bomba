...
oturum  = CloudScraper()
oturum.headers.update({"User-Agent":"Mozilla/5.0", "Referer":"https://kultfilmler.net/"})

film_link = "https://kultfilmler.net/perfume-the-story-of-a-murderer-koku-bir-katilin-hikayesi/"

...
def trstx2m3u8(url:str) -> list[dict]:
    oturum = Session()
    oturum.headers.update({"User-Agent":"Mozilla/5.0", "Referer":"https://www.fullhdfilmizlesene.now/"})
...
# konsol.print(fullhdfilmizlesene("https://www.fullhdfilmizlesene.now/film/makine-2/"))
konsol.print(fullhdfilmizlesene("https://www.fullhdfilmizlesene.now/film/iskence-okulu/"))
# konsol.print(fullhdfilmizlesene("https://www.fullhdfilmizlesene.now/film/yedi-yasam/"))
# konsol.print(fullhdfilmizlesene("https://www.fullhdfilmizlesene.now/film/cilgin-cocuklar-oyun-bitti-izle-1/"))
# konsol.print(fullhdfilmizlesene("https://www.fullhdfilmizlesene.now/film/suclu-den-skyldige/"))
# konsol.print(fullhdfilmizlesene("https://www.fullhdfilmizlesene.now/film/vahsiler-hostiles/"))
# konsol.print(fullhdfilmizlesene("https://www.fullhdfilmizlesene.now/film/satranc-oyuncusu/"))